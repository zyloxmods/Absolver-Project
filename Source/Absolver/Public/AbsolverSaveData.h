...
#include "WorldSave.h"
#include "AbsolverSaveData.generated.h"

class UCharacterBuildDB;
class UQuestItemData;

USTRUCT(BlueprintType)
struct FAbsolverSaveData {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(EditAnywhere, SaveGame, meta=(AllowPrivateAccess=true))
    TMap<uint8, uint32> m_VoiceOverProgressPerTheme;
    
    UPROPERTY(EditAnywhere, SaveGame, meta=(AllowPrivateAccess=true))
    TMap<uint8, uint32> m_BossVoiceOverProgressPerTheme;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, SaveGame, meta=(AllowPrivateAccess=true))
    bool m_bStatueVoiceOverDone;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, SaveGame, meta=(AllowPrivateAccess=true))
    uint8 m_uiPveDepthUnlocked;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, SaveGame, meta=(AllowPrivateAccess=true))
    uint8 m_uiLastPveNbPlayersForGameMode;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, SaveGame, meta=(AllowPrivateAccess=true))
    uint8 m_uiLastPveDepthMaskSelected;
    
    ABSOLVER_API FAbsolverSaveData();
};
